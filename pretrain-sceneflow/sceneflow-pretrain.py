...
TrainImgLoader = torch.utils.data.DataLoader(
    ...
    batch_size=batchSize, shuffle= True, num_workers= 8, drop_last=False)
...
def main():
    ...
    # print('average test loss = %.3f' %(total_test_loss/(epoch+1)))
    # ----------------------------------------------------------------------------------

    # SAVE test information
    savefilename = root_path + args.savemodel+'sceneflow_testinformation.tar'
    torch.save({
